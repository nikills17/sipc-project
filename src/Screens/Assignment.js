...
const Assignment = ({navigation}) => {
  ...
  return (
    <View style={[SIPCStyles.flex, {backgroundColor: '#f2f1f6'}]}>
      ...
      {/* ----------------------------------------------------------------------- */}
      <Surface
        style={{backgroundColor: '#3a7fc4', padding: 15, alignItems: 'center'}}>
      ...
      <View
        ...
        <Card
          ...
          <Text
            style={[
              SIPCStyles.NormalFont,
              {color: Active == 2 ? '#1485cc' : '#525252', textAlign: 'center'},
            ]}>
            All Staff
          </Text>
        </Card>
        ...
        <Card
          ...
          <Text
            style={[
              SIPCStyles.NormalFont,
              {color: Active == 3 ? '#1485cc' : '#525252', textAlign: 'center'},
            ]}>
            Add New Staff
          </Text>
        </Card>
            ...
            <View style={{margin: 20}}>
              ...
              <View style={{flexDirection: 'column'}}>
                <Text
                  style={[
                    SIPCStyles.NormalFont,
                    {marginTop: 20, marginLeft: deviceWidth > 500 ? 25 : 10},
                  ]}>
            ...
            <View style={{flexDirection: 'column'}}>
              ...
              <View style={SIPCStyles.AddNEwStaffContainer}>
                ...
                <TextInput
                  ...
                  value={
                    selectedDate2
                      ? selectedDate2.toLocaleDateString('en-US', {
                          month: 'short',
                          day: 'numeric',
                          year: 'numeric',
                        })
