        ...
        <View
          ...
          <Card
            ...
            style={{
              ...
              borderColor: Tab == 1 ? '#1485cc' : 'transparent',
            }}
            onPress={() => setTab(1)}>
            <Text
              style={[
                SIPCStyles.NormalFont,
                {color: Tab == 1 ? '#1485cc' : '#525252'},
              ]}>
              Work Orders
            </Text>
          </Card>
          ...
          <Card
            ...
            style={{
              ...
              borderColor: Tab == 2 ? '#1485cc' : 'transparent',
            }}
            onPress={() => setTab(2)}>
            <Text
              style={[
                SIPCStyles.NormalFont,
                {color: Tab == 2 ? '#1485cc' : '#525252'},
              ]}>
              In Progress
            </Text>
          </Card>
          ...
          <Card
            ...
            style={{
              ...
              paddingVertical: 15,
              backgroundColor: 'white',
              borderBottomWidth: Tab == 3 ? 1 : 0,
              borderColor: Tab == 3 ? '#1485cc' : 'transparent',
            }}
            onPress={() => setTab(3)}>
            <Text
              style={[
                SIPCStyles.NormalFont,
                {color: Tab == 3 ? '#1485cc' : '#525252'},
              ]}>
              Completed
            </Text>
          </Card>
          ...
          <>
              ...
              <Surface style={{backgroundColor: 'white'}}>
                ...
                <View style={{flexDirection: 'row', padding: 15}}>
                  ...
                  <Text
                    ...
                    Work Order section is completed & inspected thoroughly with
                    all the items
                  </Text>
                </View>
                <Divider bold={true} />
            ...
            <Surface
              style={{
                marginTop: 20,
                padding: 15,
                backgroundColor: Active == 2 ? '#fffcf8' : 'white',
              }}>
              <View
                style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                <View style={{flexDirection: 'column'}}>
          ...
          <>
            <Surface
              style={{
                marginTop: 20,
                padding: 15,
                backgroundColor: Progress == 1 ? '#fffcf8' : 'white',
              }}>
              <View
                style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                <View style={{flexDirection: 'column'}}>
            ...
            <Surface
              style={{
                marginTop: 20,
                padding: 15,
                backgroundColor: Progress == 2 ? '#fffcf8' : 'white',
              }}>
              <View
                style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                <View style={{flexDirection: 'column'}}>
          ...
          <>
            <Surface
              style={{
                marginTop: 20,
                padding: 15,
                backgroundColor: Complete == 1 ? '#fffcf8' : 'white',
              }}>
              <View
                style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                <View style={{flexDirection: 'column'}}>
            ...
            <Surface
              style={{
                marginTop: 20,
                padding: 15,
                backgroundColor: Complete == 2 ? '#fffcf8' : 'white',
              }}>
              <View
                style={{flexDirection: 'row', justifyContent: 'space-between'}}>
                <View style={{flexDirection: 'column'}}>
