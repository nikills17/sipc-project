...
const SavePendingSurvey = ({ navigation, route }) => {
  ...
  const uploadImage = async (
    ...
    if (imagePath != null) {
      ...
      data.append(
        'survey_session_id',
        surveySessionId == undefined ? '' : surveySessionId,
      );
      data.append(
        ...
        <View
          ...
          <>
            <TouchableOpacity
              ...
              <View style={{ borderWidth: 0.8, height: '100%', borderColor: '#CCCCCC', }} />
              {/* ================================================================ */}
              <Text
                style={{
      ...
      <>
        <View
          style={{
            flexDirection: 'row',
            alignItems: 'center',
            marginHorizontal: deviceWidth > 500 ? 50 : 20,
            marginVertical: deviceWidth > 500 ? 5 : 0,
            borderWidth: 1,
            borderColor: '#CCCCCC',
            borderRadius: 10,
            marginTop: 15,
          ...
          <View
            style={{ borderWidth: 0.8, height: '100%', borderColor: '#CCCCCC' }}
          />
          {/* ======================================== */}
          <Text
            style={{
  ...
  const SurveyQuestions = ({ data, indexValue }) => {
  ...
  return (
    <View style={SIPCStyles.flex}>
      ...
      <ScrollView>
        ...
        {/* ===============================MULTIPLE============================ */}
        {data.map((item, index) => {
          return <SurveyQuestions data={item} key={index} indexValue={index}/>;
        })}
        {/* ============================================================ */}
      </ScrollView>
