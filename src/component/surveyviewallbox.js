      ...
      {Active === 1 ?
        <>
          <Surface style={{ padding: 15, marginTop: 20, backgroundColor: Show == true ? '#fffcf8' : 'white' }}>
            <Grid>
              <Col size={68} style={{ justifyContent: 'center', paddingRight: 10, }}>
                <View style={{ flexDirection: 'column' }}>
                  ...
                  <View style={SIPCStyles.ViewRowAlign} >
                    ...
                    <Text style={SIPCStyles.SurfaceTitle}>{data.survey_name}</Text>
                  </View>
            ...
            <>
              <Surface style={{ backgroundColor: 'white', }}>
                ...
                <View style={{ flexDirection: 'row', padding: 15 }}>
                  ...
                  <Text style={[SIPCStyles.ValueFont, { flex: 1 }]}>{data.organization_name}</Text>
                </View>
                <Divider bold={true} />
                {/* ============ */}
                <View style={{ flexDirection: 'row', padding: 15 }}>
                  <Text style={[SIPCStyles.BoldFont, { paddingRight: 10 }]}>Survey Created:</Text>
                  <Text style={SIPCStyles.ValueFont}> {data.survey_create_date}</Text>
                </View>
                <Divider bold={true} />
                {/* ================ */}
                <View style={{ flexDirection: 'row', padding: 15 }}>
                ...
                <View style={{ flexDirection: 'row', padding: 15 }}>
                  ...
                  <Text style={SIPCStyles.ValueFont}>{data.first_name} {data.last_name}</Text>
                </View>
                <Divider bold={true} />
                {/* ================ */}
                <View style={{ flexDirection: 'row', padding: 15 }}>
        ...
        <>
          <Surface style={{ padding: 15, marginTop: 20, backgroundColor: PendingShow == true ? '#fffcf8' : 'white' }}>
            <Grid>
              <Col size={68} style={{ justifyContent: 'center', paddingRight: 10, }}>
                <View style={{ flexDirection: 'column' }}>

                  <View style={SIPCStyles.ViewRowAlign} >
                    <TouchableWithoutFeedback onPress={() => { setPendingShow(!PendingShow) }}>
                      {PendingShow == true ?
